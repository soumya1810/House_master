...
<html lang="en">
<head>
  <title>Feedback Form - House Master Residents Dashboard</title>
        ...
        <div class="col-xl-12 order-xl-1">
          <div class="card bg-secondary shadow">
            ...
            <div class="card-body pb-5">
              <form method="POST" autocomplete="off" action="residentshandler.php">
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-md-6">
...
$house_idd = $_SESSION['house_id'];
$reqids_query = "Select request_id,name from 
cleanrequest cr Inner JOIN housekeeper hk on cr.worker_id=hk.worker_id 
inner join residents s on s.house_id = cr.house_id
where cr.req_status = 1 and s.house_id = '$house_idd'";
