<?php
  ...
  if(isset($_POST['reqSubmit']) && isset($_SESSION['house_id'])){
    ...
    $req_query = "INSERT into cleanrequest(house_id,date,cleaningtime) values ('$house_id','$reqdate','$reqTime')";
  ...
  // ================== Feedback Handler =================== //
  if(isset($_POST['feedSubmit'])  && isset($_SESSION['house_id']) ){
    ...
    $feed_query = "INSERT into feedback(house_id,request_id,rating,timein,timeout) values ('$house_id','$feedreqid','$feedrating','$feedtimein','$feedtimeout')";
    ...
    if($feedsuggestion != ""){
      $suggest_query = "INSERT into suggestions(feedback_id,house_id,suggestion) values ('$feedid3','$house_id','$feedsuggestion')";
      $suggest_result = mysqli_query($db, $suggest_query);
    }

    if($feedcomplaints != ""){
      $complaint_query = "INSERT into complaints(feedback_id,house_id,complaint) values ('$feedid3','$house_id','$feedcomplaints')";
