              ...
              <form method="POST" autocomplete="off" action="allothandler.php">
                <div class="pl-lg-4">
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        <label class="form-control-label" for="input-house">House Number</label>
                        <input type="text" name="allotHouse" id="input-house" class="form-control" disabled value="<?php if(isset($_GET['house_num'])){ echo $_GET['house_num']; }?>">
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group">
...
$workerIds_query = "Select worker_id, name, floor from housekeeper where tower='$tower_name'";
