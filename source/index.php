...
<html lang="en">
<head>
  <title>House Master Residents Dashboard</title>
...
<body>
  ...
  <div class="main-content">
      ...
      <div class="container-fluid">
        ...
        <?php if (isset($_SESSION['residents_logged'])) : ?>
          <div class="alert alert-success alert-dismissible fade show" role="alert">
            <span class="alert-inner--icon"><i class="ni ni-like-2"></i></span>
            <span class="alert-inner--text"><strong>Welcome to online Housekeeping service.</strong>
            <?php echo $_SESSION['residents_logged']; unset($_SESSION['residents_logged']); ?>
          </span>
          ...
          <div class="card shadow">
            ...
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
<?php 
$requestrows = getRequests($_SESSION['house_id'], $db);
if($requestrows){
