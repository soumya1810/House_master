...
<head>
  ...
  <title>House Master Admin Login</title>
    ...
    <div class="row parent-row">
      ...
      <div class="col s12 l5">
        <div class="center-align form-align">
          <h4>Sign In</h4>
          <p class="hide-on-large-only">Browse residents requests and complaints. Allot Housekeepers.</p>
          <div class="row">
            <form action="" method="POST" autocomplete="off" class="col s12">
              <?php include("errors.php") ?>
              <div class="row flex-h-center mb-0">
                <div class="input-field col s8">
                  <input type="text" name="adminUsername" id="house_id" class="validate" required>
                  <label for="house_id">Username</label>
                </div>
              </div>
            ...
            <a class="link" href="login.php">or Residents login</a>
          </div>
        </div>
      </div>
    </div>
