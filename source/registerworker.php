...
<html lang="en">
<head>
  <title>Register HouseKeeper - House Master Admin Dashboard</title>
              ...
              <form method="POST" autocomplete="off" action="allothandler.php">
                <div class="pl-lg-4">
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        <label class="form-control-label" for="input-house">Floor <span class="text-danger">*</span></label>
                        <input type="number" name="regFloor" id="input-house" class="form-control" required placeholder="Enter numeric value">
                      </div>
                    </div>
                  </div>
